...
# Only run in high-precision mode: MMseqs2 kmer prefilter (k=5) can miss valid matches
# for short sequences (5-7 aa), leaving them as incorrect singletons. This step checks
# each singleton representative against all non-singleton centroids using bounded
